...
% CS6400 MSc Computing Science dissertation (uccthesis).
% Do not alter uccthesis.cls settings that affect font, spacing, or layout.
% Electronic thesis filename at Canvas submission: 125103619.pdf
...
\secondreader{TBD}% replace with assigned Second Reader before submission
\date{August 2026}
...
% Front matter (title page, abstract, declaration, ToC, LoT, LoF) is inserted by uccthesis.
% Chapter map vs CS6400 grading components:
%   Problem statement & analysis  -> Chs.~1--2
%   Main body (methods/design)    -> Chs.~3--5
%   Testing, evaluation, conclusion -> Chs.~6--7
%   Program listings              -> Appendix~\ref{ch:appendix-artefacts}

\input{chapters/01_introduction}
\input{chapters/02_related_work}
\input{chapters/03_methods}
\input{chapters/04_framework}
\input{chapters/05_metrics}
\input{chapters/06_results}
\input{chapters/07_conclusion}

\appendix
\input{chapters/A_appendix_artefacts}
